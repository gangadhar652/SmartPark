...
fun DelhiEvChargersScreen(
    onBack: () -> Unit,
    onConnaughtPlaceClick: () -> Unit,
    onCyberHubClick: () -> Unit,
    onNehruPlaceClick: () -> Unit,
    onIgiAirportClick: () -> Unit,
    onSelectCitywalkClick: () -> Unit
) {
